...
{
    public class ItemCommonInfoFile : PsuFile
    {
        ...
        public ItemCommonInfoFile(string inFilename, byte[] rawData, byte[] subHeader, int[] ptrs, int baseAddr)
        {
            filename = inFilename;
            header = subHeader;
        ...
        public override byte[] ToRaw()
        {
            ...
            outWriter.Write(0);    //Size to be.
            outWriter.Write(0);    //Header location.
