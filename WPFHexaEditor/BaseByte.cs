...
namespace WpfHexaEditor
{
    ...
    abstract class BaseByte : FrameworkElement, IByteControl
    {
        ...
        private Brush _customColor = null;
        private byte? _byte;
        private bool _isHighLight;
        protected bool waitingForRelease = false;
        ...
        /// <summary>
        /// Get of Set if control as marked as CustomColor
        /// </summary>   
        public Brush CustomColor
        {
            ...
            set
            {
                if (value.Equals(_customColor)) return;
        ...
        /// <summary>
        /// Auto highlite SelectionByte pointer data
        /// </summary>
        protected void UpdateAutoHighLiteSelectionByteVisual()
        {
            ...
            */
            if (Byte != null)
            {
                long byteAligned = _parent.SelectionStart - (_parent.SelectionStart % 4);
                if (_parent.AllowAutoHighLightSelectionByte && _parent.SelectionByte != null && _parent.PointerData != null 
                    && _parent.PointerData.ContainsKey(byteAligned))
                {
                    if(BytePositionInStream >= _parent.PointerData[byteAligned][0]
                        && BytePositionInStream <(_parent.PointerData[byteAligned][0] + _parent.PointerData[byteAligned][1]))
                    {
                        Background = _parent.AutoHighLiteSelectionByteBrush;
                    }
                }
