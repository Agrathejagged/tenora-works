...
{
    public partial class ItemSkillParamViewerPsp2 : UserControl
    {
        Psp2ItemSkillParamFile internalFile;
        List<DataGridView> grids = new List<DataGridView>();
        public ItemSkillParamViewerPsp2(Psp2ItemSkillParamFile inFile)
        {
            InitializeComponent();
            internalFile = inFile;
